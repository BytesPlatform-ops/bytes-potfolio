...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "An industry that usually settles for stock photography and a phone number. We went cinematic instead — full-bleed field imagery, serif headlines with weight behind them, and a recovery request that never sits more than one scroll away.",
